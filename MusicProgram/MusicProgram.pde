...
void setup() {
  ...
  song[currentSong] = minim.loadFile("../Music/Sunset.mp3");  //able to pass absolute path, file name, and URL
  song[currentSong+=1] = minim.loadFile("../Music/High.mp3");
  song[currentSong+=1] = minim.loadFile("../Music/Tropic.mp3");
